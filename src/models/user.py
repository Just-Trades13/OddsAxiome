...
class User(Base, TimestampMixin):
    ...
    registration_step: Mapped[str] = mapped_column(String(20), default="complete", nullable=False)
    is_admin: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)
    is_active: Mapped[bool] = mapped_column(Boolean, default=True, nullable=False)
    hide_onboarding_tip: Mapped[bool] = mapped_column(Boolean, default=False)
    market_alerts: Mapped[bool] = mapped_column(Boolean, default=False)
    live_data_stream: Mapped[bool] = mapped_column(Boolean, default=False)
